...
const static std::string ERR_NO_PROJECT_FILE = "Error: Could not find Projectfile. Did you generate a project using gb2rpg? Missing: ";
    ...
    switch(m_LoadingPhases)
    {
        ...
        case LoadingPhases::LOADING_DATABASE:
        {
            ...
            if(!fs::exists({filePath})) {
                std::cout << ERR_NO_PROJECT_FILE << filePath << std::endl;
